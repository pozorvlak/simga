...
'-bt 0.44 -bw_noreturn 0.8 -bw_non_equal 0.27 -bw_pointer 0.58 -bw_positive 0.06 -bw_float 0.0001 -bw_call 0.1 -bw_neg_return 0.85 -bw_null_return 0.17 -bw_const_return 0.48 -bw_loop_header 0.1 -bw_loop_branch 0.33 -bw_loop_exit 0.42');
is_deeply([parse_args(0.01, '-bt 0.44 -bw_noreturn 0.8 -bw_non_equal 0.27 -bw_pointer 0.58 -bw_positive 0.06 -bw_float 0.0001 -bw_call 0.1 -bw_neg_return 0.85 -bw_null_return 0.17 -bw_const_return 0.48 -bw_loop_header 0.1 -bw_loop_branch 0.33 -bw_loop_exit 0.42')], [44, 80, 27, 58, 6, 0, 10, 85, 17, 48, 10, 33, 42]);
...
'-bt 0.12 -bw_noreturn 0.17 -bw_non_equal 0.77 -bw_pointer 0.02 -bw_positive 0.6 -bw_float 0.62 -bw_call 0.39 -bw_neg_return 0.0001 -bw_null_return 0.07 -bw_const_return 0.47 -bw_loop_header 0.5 -bw_loop_branch 0.71 -bw_loop_exit 0.48');
is_deeply([parse_args(0.01, '-bt 0.12 -bw_noreturn 0.17 -bw_non_equal 0.77 -bw_pointer 0.02 -bw_positive 0.6 -bw_float 0.62 -bw_call 0.39 -bw_neg_return 0.0001 -bw_null_return 0.07 -bw_const_return 0.47 -bw_loop_header 0.5 -bw_loop_branch 0.71 -bw_loop_exit 0.48')], [12, 17, 77, 2, 60, 62, 39, 0, 7, 47, 50, 71, 48]);
is(ecc_args(0.01, 33, 40, 74, 13, 52, 87, 87, 0, 29, 14, 32, 87, 22),
'-bt 0.33 -bw_noreturn 0.4 -bw_non_equal 0.74 -bw_pointer 0.13 -bw_positive 0.52 -bw_float 0.87 -bw_call 0.87 -bw_neg_return 0.0001 -bw_null_return 0.29 -bw_const_return 0.14 -bw_loop_header 0.32 -bw_loop_branch 0.87 -bw_loop_exit 0.22');
is_deeply([parse_args(0.01, '-bt 0.33 -bw_noreturn 0.4 -bw_non_equal 0.74 -bw_pointer 0.13 -bw_positive 0.52 -bw_float 0.87 -bw_call 0.87 -bw_neg_return 0.0001 -bw_null_return 0.29 -bw_const_return 0.14 -bw_loop_header 0.32 -bw_loop_branch 0.87 -bw_loop_exit 0.22')], [33, 40, 74, 13, 52, 87, 87, 0, 29, 14, 32, 87, 22]);
...
'-bt 0.05 -bw_noreturn 0.97 -bw_non_equal 0.48 -bw_pointer 0.63 -bw_positive 0.64 -bw_float 0.94 -bw_call 0.07 -bw_neg_return 0.3 -bw_null_return 0.63 -bw_const_return 0.04 -bw_loop_header 0.48 -bw_loop_branch 0.0001 -bw_loop_exit 0.94');
is_deeply([parse_args(0.01, '-bt 0.05 -bw_noreturn 0.97 -bw_non_equal 0.48 -bw_pointer 0.63 -bw_positive 0.64 -bw_float 0.94 -bw_call 0.07 -bw_neg_return 0.3 -bw_null_return 0.63 -bw_const_return 0.04 -bw_loop_header 0.48 -bw_loop_branch 0.0001 -bw_loop_exit 0.94')], [5, 97, 48, 63, 64, 94, 7, 30, 63, 4, 48, 0, 94]);
is(ecc_args(0.01, 25, 75, 0, 26, 97, 86, 31, 67, 13, 99, 59, 58, 77),
'-bt 0.25 -bw_noreturn 0.75 -bw_non_equal 0.0001 -bw_pointer 0.26 -bw_positive 0.97 -bw_float 0.86 -bw_call 0.31 -bw_neg_return 0.67 -bw_null_return 0.13 -bw_const_return 0.99 -bw_loop_header 0.59 -bw_loop_branch 0.58 -bw_loop_exit 0.77');
is_deeply([parse_args(0.01, '-bt 0.25 -bw_noreturn 0.75 -bw_non_equal 0.0001 -bw_pointer 0.26 -bw_positive 0.97 -bw_float 0.86 -bw_call 0.31 -bw_neg_return 0.67 -bw_null_return 0.13 -bw_const_return 0.99 -bw_loop_header 0.59 -bw_loop_branch 0.58 -bw_loop_exit 0.77')], [25, 75, 0, 26, 97, 86, 31, 67, 13, 99, 59, 58, 77]);
